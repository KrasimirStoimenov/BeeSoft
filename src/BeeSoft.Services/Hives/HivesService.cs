...
using BeeSoft.Data;
using BeeSoft.Services.Hives.Mappings;
using BeeSoft.Services.Hives.Models;

using Microsoft.EntityFrameworkCore;

public sealed class HivesService(BeeSoftDbContext dbContext) : IHivesService
{
    public async Task<ICollection<HiveListingServiceModel>> GetHivesAsync()
        => await dbContext.Hives
            .Include(a => a.Apiary)
            .ProjectToHiveListingServiceModel()
            .ToListAsync();
